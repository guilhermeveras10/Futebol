...
var JecCapPage = (function () {
    ...
    JecCapPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-jec-cap',template:/*ion-inline-start:"/home/guilherme/workspace/Futebol/src/pages/jec-cap/jec-cap.html"*/'<!--\n  Generated template for the DetalheNoticiaPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="vermelhoEscuro">\n    <button ion-button menuToggle right>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>JEC Cap</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <img src="assets/imgs/download.png" class="img" />\n  <img src="assets/imgs/jeccap.png" class="img2" />\n  <button ion-fab color="vermelhoEscuro" style="position: absolute;left: 7%;top:53%;height: 6%;width: 9%;">\n    <ion-icon name="game-controller-a"></ion-icon>\n  </button>\n  <button ion-fab color="vermelhoEscuro" style="position: absolute;left: 30%;top:53%;height: 6%;width: 9%;">\n    <ion-icon name="game-controller-a"></ion-icon>\n  </button>\n  <button ion-fab color="vermelhoEscuro" style="position: absolute;left: 55%;top:53%;height: 6%;width: 9%;">\n    <ion-icon name="game-controller-a"></ion-icon>\n  </button>\n  <button ion-fab color="vermelhoEscuro" style="position: absolute;left:78%;top:53%;height: 6%;width: 9%;">\n    <ion-icon name="game-controller-a"></ion-icon>\n  </button>\n</ion-content>\n'/*ion-inline-end:"/home/guilherme/workspace/Futebol/src/pages/jec-cap/jec-cap.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"]])
    ], JecCapPage);
    return JecCapPage;
